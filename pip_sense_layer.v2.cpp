...
void play()
{
    ...
    system("xterm -e \"play alarm2.mp3\"");
...
void stop()
{
    ...
    killalarm = false;
    if(clothes== 0)
        system("xterm -hold -e \"echo It is warm/hot outside: No need for extra sweater or jacket \"");
    else if(clothes == 1)
        system("xterm  -hold -e \"echo It is chilly outside: Recommended to wear a sweater or jacket.\"");
    else
        system("xterm -hold -e \"echo It is cold outside: Recommended to wear a thicker coat.\"");
    stop();
}
...
*/                if (not parity_failed) {
                                    ...
                                    frnht= (celc*9.0/5.0 +32);
                                    printf(" temp (F): %.2f", frnht);
         ...
         *
          {
            printf("It's going to be hot wear shorts");
          }
          else
          {
            printf("It's going to be cold wear a jacket");
          }
         *
         *
         *
        ...
        if(data_light ==0)
        {
          printf("turning on alarm, please move tag closer to reciever to turm it off");
          sleep(5);
...
int main(int ac, char** arg_vector) {
    ...
    thread second(stop);
    thread third(play);
    thread first(code,ac,arg_vector);second.join();
    third.join();
